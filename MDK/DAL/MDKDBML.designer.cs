...
namespace DAL
{
    ...
    partial void OnBusinessGUIDChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="PersonalInformation_ITInfo1", Storage="_PersonalInformation1", ThisKey="BusinessGUID", OtherKey="BusinessGUID", IsForeignKey=true)]
			...
			set
			{
							...
							|| (this._PersonalInformation1.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((previousValue != null))
					{
						...
						previousValue.ITInfos1.Remove(this);
					}
					this._PersonalInformation1.Entity = value;
					if ((value != null))
					{
						value.ITInfos1.Add(this);
						this._BusinessGUID = value.BusinessGUID;
					}
					else
					{
    ...
    partial void OnBusinessGUIDChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="PersonalInformation_OtherInfo1", Storage="_PersonalInformation1", ThisKey="BusinessGUID", OtherKey="BusinessGUID", IsForeignKey=true)]
		public PersonalInformation PersonalInformation1
		{
			get
			{
			...
			set
			{
							...
							|| (this._PersonalInformation1.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._PersonalInformation1.Entity = null;
						previousValue.OtherInfos1.Remove(this);
					}
					this._PersonalInformation1.Entity = value;
					if ((value != null))
					{
						value.OtherInfos1.Add(this);
						this._BusinessGUID = value.BusinessGUID;
					}
					else
					{
    ...
    partial void OnBusinessGUIDChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="PersonalInformation_ITInfo1", Storage="_ITInfos1", ThisKey="BusinessGUID", OtherKey="BusinessGUID")]
		public EntitySet<ITInfo> ITInfos1
		{
			get
			{
				return this._ITInfos1;
			}
			set
			{
				this._ITInfos1.Assign(value);
			}
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="PersonalInformation_OtherInfo1", Storage="_OtherInfos1", ThisKey="BusinessGUID", OtherKey="BusinessGUID")]
		public EntitySet<OtherInfo> OtherInfos1
		{
			get
			{
				return this._OtherInfos1;
			}
			set
			{
				this._OtherInfos1.Assign(value);
			}
		}
		...
		private void attach_ITInfos1(ITInfo entity)
		{
			this.SendPropertyChanging();
			entity.PersonalInformation1 = this;
		}
		
		private void detach_ITInfos1(ITInfo entity)
		{
			this.SendPropertyChanging();
		...
		private void attach_OtherInfos1(OtherInfo entity)
		{
			this.SendPropertyChanging();
			entity.PersonalInformation1 = this;
		}
		
		private void detach_OtherInfos1(OtherInfo entity)
		{
			this.SendPropertyChanging();
			entity.PersonalInformation1 = null;
		}
